...
* When there are multiple phrasings of the same answer, for instance 'yes, it was' and 'yes', or '24 hours' and '1 day', you must answer them all consistently
 
* If there are no good answers, just say no to all of them.
"""}
...
def evaluate():
    ...
    false_n = 0
    false_p = 0
    pbar = tqdm(list(enumerate(data_dev[k:])))
